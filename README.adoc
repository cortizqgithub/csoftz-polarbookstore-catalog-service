...
then it will populate the Book database table with some test data. This profile must not be activated for other
environments or even in local development should you need empty data or existing data.
